...
def save_data(w, portfolio_scale=1e+8, fund_nav=None, details='', fun='', fund_pool_fun='', end_date=date.today()):
    ...
    coefficient.to_csv(os.getcwd() + "\\vill\\results\\coefficient_" + fund_pool_fun + "_" + fun + ".csv", index=True,
                       encoding="utf_8_sig")
    coefficient.to_csv(
        os.getcwd() + "\\vill\\snapshots\\coefficient_" + fund_pool_fun + "_" + fun + "_" + int(

...
def get_fv_data():
    ...
    data = {
        ...
        "message": message,
        "content": {
            "date": date_re, "chart1": chart1, "chartadd1": chartadd1,
            "in1": in1,
            "duration": duration,
...
def test_chart():
    ...
    history[1] = history[0].rstrip('\n')
    history[2] = history[0].rstrip('\n')
    data_chart = {"history_high": history[0], "history_mid": history[1], "history_low": history[2]}
    data = {
        "success": success,
        "message": message,
        "content": data_chart
